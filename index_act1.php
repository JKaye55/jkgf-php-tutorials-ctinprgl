...
$check_email = mysqli_query($connections, "SELECT * FROM mytbl WHERE email_address='$email'");
...
$query= mysqli_query($connections, "INSERT INTO mytbl (name,address,email_address,section,contact,password,account_type) VALUES ('$name', '$address', '$email', '$section', '$contact', '$cpassword', '2')");
...
Email: <input type= "text" name="email_address" value="<?php echo $email; ?>"> <br>
